<%@ Control Language="C#" CodeBehind="CustomDefaultVerticalTemplateContent.ascx.cs" ClassName="CustomDefaultVerticalTemplateContent" Inherits="XCRM.Web.CustomDefaultVerticalTemplateContent" %>
<%@ Register Assembly="DevExpress.Web.v18.2, Version=18.2.1.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web" TagPrefix="dx" %>
<%@ Register Assembly="DevExpress.ExpressApp.Web.v18.2, Version=18.2.1.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.ExpressApp.Web.Templates.ActionContainers"
    TagPrefix="xaf" %>
<%@ Register Assembly="DevExpress.ExpressApp.Web.v18.2, Version=18.2.1.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.ExpressApp.Web.Templates"
    TagPrefix="xaf" %>
<%@ Register Assembly="DevExpress.ExpressApp.Web.v18.2, Version=18.2.1.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.ExpressApp.Web.Controls"
    TagPrefix="xaf" %>
<%@ Register Assembly="DevExpress.ExpressApp.Web.v18.2, Version=18.2.1.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.ExpressApp.Web.Templates.Controls"
    TagPrefix="xaf" %>
<%@ Register TagPrefix="uc" TagName="BaseColorSelector" Src="~/BaseColorSelector/BaseColorSelector.ascx" %>
<link href="BaseColorSelector/styles.css" rel="stylesheet" />
<script src="BaseColorSelector/Utils.js"></script>
        ...
        <table id="headerTable" class="headerTable xafAlignCenter white width100 <%= AdditionalClass %>">
            <tbody>
                <tr>
                    ...
                    <td class="color-selector-wrapper">
                        <div class="color-selector-container">
                            <uc:BaseColorSelector ID="BaseColorSelector" runat="server" />
                        </div>
                    </td>
                    <td>
